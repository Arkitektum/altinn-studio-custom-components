...
import CustomGrouplistOmraaderisikoer from "../classes/system-classes/component-classes/CustomGrouplistOmraaderisikoer.js";
...
export function instantiateComponent(element) {
    ...
    switch (tagName?.toLowerCase()) {
        ...
        case "custom-grouplist-omraaderisikoer":
            return new CustomGrouplistOmraaderisikoer(component);

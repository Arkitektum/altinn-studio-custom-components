...
export interface PosisjonProps {
    ...
    /** An object holding the coordinate list, which is handed on untouched. */
    koordinater?: { koordinat?: unknown } | null;
...
export default class Posisjon {
    ...
    declare koordinater?: { koordinat?: unknown } | null;
     ...
     * @param {Object} [props.koordinater] - The coordinates associated with the position.
     */

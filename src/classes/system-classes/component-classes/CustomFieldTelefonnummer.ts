...
import type { TelefonnumreProps } from "../../data-classes/Telefonnumre.ts";
// Dependencies
...
import Telefonnumre from "../../data-classes/Telefonnumre.ts";
...
export default class CustomFieldTelefonnummer extends CustomComponent {
     ...
     */
    formatPhoneNumbers(telefonnumre?: { telefonnummer?: string | null; mobilnummer?: string | null; telefon?: string | null }): string {

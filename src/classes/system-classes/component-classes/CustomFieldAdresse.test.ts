...
import CustomFieldAdresse from "./CustomFieldAdresse.ts";
...
jest.mock("../../../functions/helpers", () => ({
    ...
    getComponentResourceValue: jest.fn((props: ComponentProps, key: string) => props.resourceBindings?.[key] || `resource.${key}`),
...
describe("CustomFieldAdresse", () => {
    ...
    describe("formatAdresse", () => {
        let instance: CustomFieldAdresse;
        beforeEach(() => {

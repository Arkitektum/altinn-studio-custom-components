 ...
 */
/**
 * The part a gjennomfoeringsplan row shows.
 *
 * Not the Part data class: this one carries a tiltaksklasse, and the table reads only the three fields it shows.
 */
export interface GjennomfoeringsplanPart {
    navn?: unknown;
    organisasjonsnummer?: unknown;
    tiltaksklasse?: unknown;
}
...
export default class CustomTablePartGjennomfoeringsplan extends CustomComponent {
    ...
    getValueFromFormData(props: ComponentProps): unknown {
        ...
        return this.hasPartValue(data as GjennomfoeringsplanPart | undefined) ? data : undefined;
    }
     ...
     */
    hasNavn(part?: GjennomfoeringsplanPart): boolean {
     ...
     */
    hasOrganisasjonsnummer(part?: GjennomfoeringsplanPart): boolean {
     ...
     */
    hasTiltaksklasse(part?: GjennomfoeringsplanPart): boolean {
     ...
     */
    hasPartValue(part?: GjennomfoeringsplanPart): boolean {

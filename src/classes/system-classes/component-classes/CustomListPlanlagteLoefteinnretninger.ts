...
import type { LoefteinnretningerProps } from "../../data-classes/Loefteinnretninger.ts";
// Dependencies
import { getTextResourceFromResourceBinding, hasValue } from "@arkitektum/altinn-studio-custom-components-utils";

// Classes
import CustomComponent from "../CustomComponent.ts";
import Loefteinnretninger from "../../data-classes/Loefteinnretninger.ts";
import PlanlagteLoefteinnretningerList from "../data-classes/PlanlagteLoefteinnretningerList.ts";
...
export default class CustomListPlanlagteLoefteinnretninger extends CustomComponent {
    ...
    getValueFromFormData(
        ...
        const loefteinnretninger = new Loefteinnretninger(data as LoefteinnretningerProps | undefined);
    ...
    getComponentUsage(): string[] {
        return ["custom-feedbacklist-validation-messages", "custom-field", "custom-list"];
    }
}

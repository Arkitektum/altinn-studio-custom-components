...
import type { EiendomProps } from "../../data-classes/Eiendom.ts";
// Dependencies
import { getTextResourceFromResourceBinding, hasValue } from "@arkitektum/altinn-studio-custom-components-utils";

// Classes
import CustomComponent from "../CustomComponent.ts";
import Eiendom from "../../data-classes/Eiendom.ts";
 ...
 */
/**
 * The fields of an eiendom this table reads, which an Eiendom carries and a caller can name directly.
 */
export interface EiendomFields {
    kommunenavn?: unknown;
    adresse?: { postnr?: unknown; poststed?: unknown; adresselinje1?: unknown; adresselinje2?: unknown; adresselinje3?: unknown } | null;
    bolignummer?: unknown;
    bygningsnummer?: unknown;
    eiendomsidentifikasjon?: { gaardsnummer?: unknown; bruksnummer?: unknown; seksjonsnummer?: unknown; festenummer?: unknown } | null;
}
...
export default class CustomTableNaboGjenboerEiendom extends CustomComponent {
     ...
     */
    getEiendomListFromData(data: unknown): Eiendom[] | undefined {
        if (!hasValue(data)) {
            return undefined;
        }
        return (data as { matrikkelinformasjon?: EiendomProps }[])
            .map((eiendom) => new Eiendom(eiendom?.matrikkelinformasjon))
            .filter((eiendom) => this.hasEiendomValue(eiendom));
    }
     ...
     */
    hasKommunenavn(eiendom?: EiendomFields): boolean {
     ...
     */
    hasZipCodeOrCity(eiendom?: EiendomFields): boolean {
     ...
     */
    hasAdresseLinje(eiendom?: EiendomFields): boolean {
     ...
     */
    hasAdresse(eiendom?: EiendomFields): boolean {
     ...
     */
    hasEiendomNummerField(eiendom?: EiendomFields): boolean {
        return (
     ...
     */
    hasEiendomValue(eiendom?: EiendomFields): boolean {
    ...
    getComponentUsage(): string[] {
        return ["custom-feedbacklist-validation-messages", "custom-field-adresse", "custom-field-data", "custom-table-data"];
    }
}

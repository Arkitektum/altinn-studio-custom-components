...
import CustomTableOmraaderisiko from "./CustomTableOmraaderisiko.ts";
...
describe("CustomTableOmraaderisiko", () => {
    ...
    describe("getValidationMessages", () => {
        it("should call hasMissingTextResources with window.textResources", () => {
            globalThis.window = { textResources: ["a", "b"] } as unknown as Window & typeof globalThis;
            hasMissingTextResources.mockReturnValue(true);
            const instance = new CustomTableOmraaderisiko({});
            expect(instance.getValidationMessages({} as unknown as Record<string, ResourceBindingGroup>)).toBe(true);
        ...
        it("should call hasMissingTextResources with empty array if window.textResources is undefined", () => {
            ...
            hasMissingTextResources.mockReturnValue(false);
            const instance = new CustomTableOmraaderisiko({});
            expect(instance.getValidationMessages({} as unknown as Record<string, ResourceBindingGroup>)).toBe(false);
    ...
    describe("hasOmraaderisikoValue", () => {
        it("should return true if hasRisikotype or hasSikkerhetsklasse returns true", () => {
            ...
            (instance.hasRisikotype as unknown as jest.Mock).mockReturnValue(false);
            (instance.hasSikkerhetsklasse as unknown as jest.Mock).mockReturnValue(true);
            expect(instance.hasOmraaderisikoValue({})).toBe(true);

            (instance.hasRisikotype as unknown as jest.Mock).mockReturnValue(false);
            (instance.hasSikkerhetsklasse as unknown as jest.Mock).mockReturnValue(false);

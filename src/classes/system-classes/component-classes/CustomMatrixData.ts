import type { CellComponentProps, ComponentOrder, ComponentProps, MatrixData, TableHeader } from "../../../types.ts";
// Dependencies
...
export default class CustomMatrixData extends CustomComponent {
    ...
    declare resourceValues: { title?: unknown; data?: MatrixData | string | null };
     ...
     */
    getValueFromFormData(props: ComponentProps): MatrixData | null {
     ...
     */
    sortRowsByKey(sortKey: string, direction: string | undefined, rows: unknown): unknown {
     ...
     */
    getMatrixHeadersFromProps(props?: ComponentProps): TableHeader[] {
     ...
     */
    getMatrixRowsFromProps(props: ComponentProps, data: unknown): CellComponentProps[][] {
        const tableColumns = props?.tableColumns || [];
     ...
     */
    getValidationMessagesFromProps(props?: ComponentProps) {
     ...
     */
    removeEmptyMatrixRows(matrixRows: unknown): CellComponentProps[][] {
        return removeEmptyRows(matrixRows) as CellComponentProps[][];
    }
     ...
     */
    hasContent(formData: unknown): boolean {
        ...
        return hasValue((formData as { matrixRows?: unknown } | undefined)?.matrixRows);
    }

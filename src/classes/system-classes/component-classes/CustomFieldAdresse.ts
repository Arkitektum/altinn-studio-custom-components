...
import type { AdresseProps } from "../../data-classes/Adresse.ts";
// Dependencies
 ...
 */
/** The fields of an address this component formats, which an Adresse carries and a caller can name directly. */
export interface AdresseFields {
...
export default class CustomFieldAdresse extends CustomComponent {
     ...
     */
    formatAdresselinje(adresse?: AdresseFields): string {
     ...
     */
    formatZipCity(adresse?: AdresseFields): string {
     ...
     */
    formatKommunenavn(adresse?: AdresseFields): string {
     ...
     */
    formatAdresse(adresse?: AdresseFields, resourceBindings?: ResourceBindingGroup): string {
    ...
    getResourceBindings(props?: ComponentProps) {
        const resourceBindings: { adresse: ResourceBindingGroup } = {
            adresse: {}
        };

...
export default class CustomFieldRow extends CustomComponent {
    declare resourceValues: { title?: unknown; data?: ComponentProps[] };
     ...
     */
    getCellsFromProps(props: ComponentProps): ComponentProps[] {
     ...
     */
    hasContent(cells: unknown): boolean {
        return Array.isArray(cells) && cells.some((cell: ComponentProps) => !instantiateComponent(cell)?.isEmpty);
    }

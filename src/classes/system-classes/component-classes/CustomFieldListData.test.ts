...
import CustomFieldListData from "./CustomFieldListData.ts";
import { getComponentDataValue } from "../../../functions/helpers.ts";
import { hasValue } from "@arkitektum/altinn-studio-custom-components-utils";

// Mocks for dependencies
jest.mock("../../../functions/helpers.ts", () => ({
    getComponentDataValue: jest.fn((props: { data?: unknown }) => props.data)
}));
...
describe("CustomFieldListData", () => {
    ...
    describe("constructor", () => {
        it("should set isEmpty to true if data is empty", () => {
            ...
            const instance = new CustomFieldListData({ data: [], dataItemKey: "id", dataTitleItemKey: "name" } as unknown as ComponentProps);
    ...
    describe("getValueFromFormData", () => {
        it("should return array of {title, data} when both keys are present", () => {
            ...
            (getComponentDataValue as unknown as jest.Mock).mockReturnValue(props.data);

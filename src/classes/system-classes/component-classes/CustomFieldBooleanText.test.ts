...
import CustomFieldBooleanText from "./CustomFieldBooleanText.ts";
...
describe("CustomFieldBooleanText", () => {
    ...
    it("should set isEmpty and use emptyFieldText when hasContent returns false", () => {
        ...
        (getTextResourceFromResourceBinding as unknown as jest.Mock).mockReturnValue("Tomt");
    ...
    it("should use default emptyFieldText if not provided", () => {
        ...
        (hasValue as unknown as jest.Mock).mockReturnValue(false);
        (getTextResourceFromResourceBinding as unknown as jest.Mock).mockReturnValue("resource.emptyFieldText.default");

...
import type { ArealdisponeringProps } from "../../data-classes/Arealdisponering.ts";
// Dependencies
 ...
 */
/** The two groups a summation answers with, of which this component reads only whether each has data. */
export interface ArealdisponeringSummationFields {
    bebyggelsen?: { resourceValues?: { data?: unknown } } | null;
    tomtearealet?: { resourceValues?: { data?: unknown } } | null;
}
...
export default class CustomSummationArealdisponering extends CustomComponent {
    ...
    getValueFromFormData(
        ...
        const arealdisponering = new Arealdisponering(data as ArealdisponeringProps | undefined);
     ...
     */
    hasArealdisponeringSummationProps(arealdisponering?: ArealdisponeringSummationFields): boolean {
     ...
     */
    hasBebyggelsenData(arealdisponering?: ArealdisponeringSummationFields): boolean {
     ...
     */
    hasTomtearealetData(arealdisponering?: ArealdisponeringSummationFields): boolean {

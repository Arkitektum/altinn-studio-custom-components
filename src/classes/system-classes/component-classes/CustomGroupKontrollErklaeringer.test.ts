...
import CustomGroupKontrollErklaeringer from "./CustomGroupKontrollErklaeringer.ts";
...
describe("CustomGroupKontrollErklaeringer", () => {
    ...
    describe("constructor", () => {
        it("should set properties correctly when data is not empty", () => {
            ...
            (getComponentDataValue as unknown as jest.Mock).mockReturnValue(mockData);
    ...
    describe("getValueFromFormData", () => {
        it("should return KontrollAnsvarsomraade instance", () => {
            ...
            const result = instance.getValueFromFormData(
                ...
                resourceBindings as unknown as Record<string, ResourceBindingGroup>
            );

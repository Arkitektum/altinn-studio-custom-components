    ...
    getResourceBindings(props) {
        return {
            ...
            metadataProsjektnavn: {
                title: props?.resourceBindings?.metadataProsjektnavn?.title || "resource.metadata.prosjekt.title"
            },
            eiendomByggested: {
            ...
            soeknadGjelderType: {
                title: props?.resourceBindings?.soeknadGjelderType?.title || "resource.soeknadGjelder.type.kode.kodebeskrivelse",
            ...
            kontaktpersonForNabovarseletNavn: {
                title: props?.resourceBindings?.kontaktpersonForNabovarseletNavn?.title || "resource.navn.title",
            ...
            kontaktpersonForNabovarseletEpost: {
                title: props?.resourceBindings?.kontaktpersonForNabovarseletEpost?.title || "resource.epostadresse.title",

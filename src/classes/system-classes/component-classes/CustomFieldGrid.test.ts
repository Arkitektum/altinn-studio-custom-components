import CustomFieldGrid from "./CustomFieldGrid.ts";
...
jest.mock("@arkitektum/altinn-studio-custom-components-utils", () => ({
    ...
    getValueFromDataKey: jest.fn((data: Record<string, unknown> | undefined, key: string) => data?.[key]),
...
describe("CustomFieldGrid", () => {
    beforeEach(() => {
        jest.clearAllMocks();
        (instantiateComponent as unknown as jest.Mock).mockImplementation((cell) => ({

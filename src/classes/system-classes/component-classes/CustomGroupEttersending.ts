...
import type { EttersendingProps } from "../../data-classes/Ettersending.ts";
// Dependencies
...
export default class CustomGroupEttersending extends CustomComponent {
    ...
    getComponentUsage(): string[] {
        return ["custom-feedbacklist-validation-messages", "custom-field-data", "custom-header-text", "custom-list-vedlegg", "custom-paragraph"];
    }
}

...
import CustomTableAnsvarsrettAnsvarsomraade from "./CustomTableAnsvarsrettAnsvarsomraade.ts";
...
describe("CustomTableAnsvarsrettAnsvarsomraade", () => {
    ...
    describe("getValueFromFormData", () => {
        it("should call getComponentDataValue and getAnsvarsomraadeListFromData", () => {
            ...
            (helpers.getComponentDataValue as unknown as jest.Mock).mockReturnValue(fakeData);

            const instance = new CustomTableAnsvarsrettAnsvarsomraade({});
            jest.spyOn(instance, "getAnsvarsomraadeListFromData").mockReturnValue(fakeList as never);
    ...
    describe("getAnsvarsomraadeListFromData", () => {
        ...
        it("should return array of AnsvarsrettAnsvarsomraade if data is array", () => {
            ...
            (AnsvarsrettAnsvarsomraade as unknown as jest.Mock).mockImplementation((obj, rb) => ({ ...obj, _rb: rb }));
    ...
    describe("getValidationMessages", () => {
        it("should call hasMissingTextResources", () => {
            ...
            expect(validations.hasMissingTextResources).toHaveBeenCalledWith({ foo: "bar" } as unknown as Record<string, ResourceBindingGroup>);
    ...
    describe("constructor", () => {
        it("should set isEmpty, validationMessages, hasValidationMessages, resourceBindings, resourceValues", () => {
            ...
            const getValidationMessages = jest
                ...
                .mockReturnValue(fakeValidationMessages as never);
            (validations.hasValidationMessages as unknown as jest.Mock).mockReturnValue(fakeHasValidationMessages);
        ...
        it("should set resourceValues.data to emptyFieldText if isEmpty", () => {
            ...
            const fakeValidationMessages: unknown[] = [];
            ...
            const getValidationMessages = jest
                ...
                .mockReturnValue(fakeValidationMessages as never);
            (validations.hasValidationMessages as unknown as jest.Mock).mockReturnValue(fakeHasValidationMessages);
            (getTextResourceFromResourceBinding as unknown as jest.Mock).mockReturnValue("EMPTY_TEXT");

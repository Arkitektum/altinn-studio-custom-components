 ...
 */
/** The fields of a part this table reads, which a Part carries and a caller can name directly. */
...
export default class CustomTablePart extends CustomComponent {
     ...
     */
    hasNavnOrOrganisasjonsnummer(part?: PartFields): boolean {
     ...
     */
    hasTelefonnummer(part?: PartFields): boolean {
     ...
     */
    hasEpost(part?: PartFields): boolean {
     ...
     */
    hasPartValue(part?: PartFields): boolean {

...
import CustomGroupAvloep from "./CustomGroupAvloep.ts";
...
describe("CustomGroupAvloep", () => {
    ...
    it("should initialize with empty data and default resource bindings", () => {
        ...
        const props = {} as unknown as ComponentProps;
    ...
    it("should set resourceValues.data to Avloep instance if not empty", () => {
        ...
        const instance = new CustomGroupAvloep(props as unknown as ComponentProps);
    ...
    it("getValueFromFormData should return Avloep instance", () => {
        ...
        const instance = new CustomGroupAvloep({});
        const result = instance.getValueFromFormData({ formData: "formData" } as unknown as ComponentProps);

...
import type { OvervannProps } from "../../data-classes/Overvann.ts";
// Dependencies
import { getTextResourceFromResourceBinding, hasValue } from "@arkitektum/altinn-studio-custom-components-utils";

// Classes
import CustomComponent from "../CustomComponent.ts";
import Overvann from "../../data-classes/Overvann.ts";
...
export default class CustomGroupOvervann extends CustomComponent {
    ...
    getComponentUsage(): string[] {
        return ["custom-feedbacklist-validation-messages", "custom-field-boolean-text", "custom-header-text", "custom-paragraph"];
    }
}

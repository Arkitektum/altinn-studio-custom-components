...
import CustomGrouplistSamsvarAnsvarsomraade from "./CustomGrouplistSamsvarAnsvarsomraade.ts";
...
describe("CustomGrouplistSamsvarAnsvarsomraade", () => {
    ...
    beforeEach(() => {
        ...
        (getTextResourceFromResourceBinding as unknown as jest.Mock).mockReset();
        (hasValue as unknown as jest.Mock).mockReset();

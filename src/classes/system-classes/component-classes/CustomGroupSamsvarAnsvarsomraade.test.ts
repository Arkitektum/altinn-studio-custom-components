...
import CustomGroupSamsvarAnsvarsomraade from "./CustomGroupSamsvarAnsvarsomraade.ts";
...
describe("CustomGroupSamsvarAnsvarsomraade", () => {
    ...
    describe("constructor", () => {
        it("should set isEmpty to true and resourceValues.data to emptyFieldText when data is empty", () => {
            ...
            (SamsvarAnsvarsomraade as unknown as jest.Mock).mockImplementation(() => samsvarInstance);
            ...
            spy.mockReturnValue(fakeResourceBindings as unknown as ReturnType<CustomGroupSamsvarAnsvarsomraade["getResourceBindings"]>);
    ...
    describe("getValidationMessages", () => {
        it("should delegate to hasMissingTextResources", () => {
            ...
            expect(instance.getValidationMessages("bindings" as unknown as Record<string, ResourceBindingGroup>)).toEqual(["missing"]);

...
/**
 * CustomMatrix is a custom component class that represents a matrix with resource-based content.
 * It extends the CustomComponent class and provides functionality to determine if the matrix has content.
 *
 * @class
 * @extends CustomComponent
 *
 * @param {Object} props - The properties object for the component.
 * @param {Object} [props.resourceValues] - An object containing resource values for the matrix.
 * @param {*} [props.resourceValues.data] - The data value to check for content in the matrix.
 *
 * @property {boolean} isEmpty - Indicates whether the matrix has content.

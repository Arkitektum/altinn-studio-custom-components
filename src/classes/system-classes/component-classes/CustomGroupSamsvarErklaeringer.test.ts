...
import CustomGroupSamsvarErklaeringer from "./CustomGroupSamsvarErklaeringer.ts";
...
jest.mock(
    ...
    () =>
        function SamsvarAnsvarsomraade(this: Record<string, unknown>, data: unknown, resourceBindings: unknown) {
            this.data = data;

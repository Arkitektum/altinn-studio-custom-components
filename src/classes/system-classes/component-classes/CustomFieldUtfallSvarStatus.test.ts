...
import CustomFieldUtfallSvarStatus from "./CustomFieldUtfallSvarStatus.ts";
...
jest.mock("../../data-classes/UtfallSvarStatus.ts");
...
describe("CustomFieldUtfallSvarStatus", () => {
    ...
    describe("constructor", () => {
        it("should set isEmpty, validationMessages, hasValidationMessages, and resourceValues correctly when data is present", () => {
            ...
            (UtfallSvarStatus as unknown as jest.Mock).mockImplementation((data) => data);
            ...
            (getTextResourceFromResourceBinding as unknown as jest.Mock).mockReturnValue("Tittel tekst");

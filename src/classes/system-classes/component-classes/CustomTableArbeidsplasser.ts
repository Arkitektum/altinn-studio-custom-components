...
import type { ArbeidsplasserProps } from "../../data-classes/Arbeidsplasser.ts";
// Dependencies
import { getTextResourceFromResourceBinding, hasValue } from "@arkitektum/altinn-studio-custom-components-utils";

// Classes
import Arbeidsplasser from "../../data-classes/Arbeidsplasser.ts";
...
export default class CustomTableArbeidsplasser extends CustomComponent {
    ...
    getValueFromFormData(props: ComponentProps, resourceBindings?: Record<string, ResourceBindingGroup | undefined>): unknown {
        ...
        const arbeidsplasser = new Arbeidsplasser(data as ArbeidsplasserProps | undefined);
     ...
     */
    getArbeidsplasserBeroertKeys(): string[] {
     ...
     */
    getArbeidsplasserBeroertArray(
        arbeidsplasser: Arbeidsplasser | undefined,
        arbeidsplasserBeroertKeys: string[],

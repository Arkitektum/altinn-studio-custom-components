...
import CustomGrouplistAnsvarsomraadeType from "./CustomGrouplistAnsvarsomraadeType.ts";
...
describe("CustomGrouplistAnsvarsomraadeType", () => {
    ...
    describe("constructor", () => {
        it("should set isEmpty, resourceBindings, and resourceValues when data is present", () => {
            ...
            getComponentResourceValue.mockImplementation((p: unknown, k: string) => `resource_${k}`);

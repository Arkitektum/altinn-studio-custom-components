 ...
 */
/** The fields of an omraaderisiko this table reads, which an Omraaderisiko carries. */
export interface OmraaderisikoFields {
    risikotype?: { kodebeskrivelse?: unknown } | null;
    sikkerhetsklasse?: { kodebeskrivelse?: unknown } | null;
}
...
export default class CustomTableOmraaderisiko extends CustomComponent {
     ...
     */
    getOmraaderisikoListFromData(data: unknown): Omraaderisiko[] | undefined {
        if (!hasValue(data)) {
            return undefined;
        }
     ...
     */
    hasRisikotype(omraaderisiko?: OmraaderisikoFields): boolean {
     ...
     */
    hasSikkerhetsklasse(omraaderisiko?: OmraaderisikoFields): boolean {
     ...
     */
    hasOmraaderisikoValue(omraaderisiko?: OmraaderisikoFields): boolean {

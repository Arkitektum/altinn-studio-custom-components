...
import CustomGroupSjekklistekravHeaderText from "./CustomGroupSjekklistekravHeaderText.ts";
...
describe("CustomGroupSjekklistekravHeaderText", () => {
    ...
    describe("constructor", () => {
        ...
        it("should initialize with empty props", () => {
            ...
            (getTextResourceFromResourceBinding as unknown as jest.Mock).mockReturnValue("Empty field text");
        ...
        it("should initialize with valid resource bindings when data has content", () => {
            ...
            (getTextResourceFromResourceBinding as unknown as jest.Mock)
                .mockReturnValueOnce("Checklist item")
                .mockReturnValueOnce("Checklist answer");
        ...
        it("should handle missing resource bindings gracefully", () => {
            (hasValue as unknown as jest.Mock).mockReturnValue(false);
            (getTextResourceFromResourceBinding as unknown as jest.Mock).mockReturnValue(undefined);
    ...
    describe("getValueFromResourceBindings", () => {
        let instance: CustomGroupSjekklistekravHeaderText;
        ...
        it("should extract values from valid resource bindings", () => {
            (getTextResourceFromResourceBinding as unknown as jest.Mock).mockReturnValueOnce("Item text").mockReturnValueOnce("Answer text");
        ...
        it("should handle partial resource bindings", () => {
            (getTextResourceFromResourceBinding as unknown as jest.Mock).mockReturnValueOnce("Item text").mockReturnValueOnce(undefined);
    ...
    describe("getComponentUsage", () => {
        ...
        it("should always return the same component usage", () => {
            ...
            const instance2 = new CustomGroupSjekklistekravHeaderText({ someProps: "value" } as unknown as ComponentProps);
    ...
    describe("integration scenarios", () => {
        it("should handle complete workflow with valid data", () => {
            (hasValue as unknown as jest.Mock).mockReturnValue(true);
            (getTextResourceFromResourceBinding as unknown as jest.Mock).mockReturnValueOnce("Complete item").mockReturnValueOnce("Complete answer");
        ...
        it("should handle complete workflow with empty data", () => {
            (hasValue as unknown as jest.Mock).mockReturnValue(false);
            (getTextResourceFromResourceBinding as unknown as jest.Mock).mockReturnValue("No data available");

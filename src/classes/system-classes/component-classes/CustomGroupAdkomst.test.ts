...
import CustomGroupAdkomst from "./CustomGroupAdkomst.ts";
...
jest.mock("../../data-classes/Adkomst.ts", () => {
    return jest.fn().mockImplementation((...args: unknown[]) => ({ mockAdkomst: true, data: args[0] }));
});
...
describe("CustomGroupAdkomst", () => {
    ...
    it("should set isEmpty true if no data", () => {
        ...
        const instance = new CustomGroupAdkomst(props as unknown as ComponentProps);

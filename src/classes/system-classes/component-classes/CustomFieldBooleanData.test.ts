import CustomFieldBooleanData from "./CustomFieldBooleanData.ts";
...
describe("CustomFieldBooleanData", () => {
    ...
    it("should set resourceValues.data to trueData when condition is true", () => {
        ...
        getComponentResourceValue.mockImplementation((props: Record<string, unknown>, key: string) => props[key]);

...
import CustomTablePart from "./CustomTablePart.ts";
...
describe("CustomTablePart", () => {
    ...
    describe("getResourceBindings", () => {
        it("should generate default resource bindings", () => {
            ...
            expect(result.telefonnummer!.title).toBe("resource.telefonnummer.title");
            expect(result.epost!.title).toBe("resource.epostadresse.title");

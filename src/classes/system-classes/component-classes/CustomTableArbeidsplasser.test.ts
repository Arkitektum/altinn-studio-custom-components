...
import CustomTableArbeidsplasser from "./CustomTableArbeidsplasser.ts";
...
jest.mock("../../data-classes/Arbeidsplasser.ts", () => {
    return function Arbeidsplasser(this: Record<string, unknown>, data: object) {
        return { ...data };
    };
});
...
describe("CustomTableArbeidsplasser", () => {
    ...
    describe("getValidationMessages", () => {
        ...
        it("should call hasMissingTextResources with empty array if window is undefined", () => {
            ...
            const instance = new CustomTableArbeidsplasser({});
            const result = instance.getValidationMessages({ key: "val" } as unknown as Record<string, ResourceBindingGroup>);

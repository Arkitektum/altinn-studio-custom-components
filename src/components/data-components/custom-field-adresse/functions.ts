import type { AdresseFields } from "../../../classes/system-classes/component-classes/CustomFieldAdresse.ts";
/**
 ...
 */
function formatAdresselinje(adresse: AdresseFields) {
 ...
 */
function formatZipCity(adresse: AdresseFields) {
 ...
 */
export function formatAdresse(adresse: AdresseFields) {

...
| resourceBindings.tomtearealSomLeggesTil.title               | string  | The resource binding key for the title of "tomteareal som legges til".                 | "resource.rammebetingelser.arealdisponering.tomtearealSomLeggesTil.title"      |
| resourceBindings.tomtearealSomLeggesTil.emptyFieldText      | string  | The resource binding key for placeholder text when the field has no value.             | "resource.emptyFieldText.default"                                              |
| resourceBindings.tomtearealSomLeggesTil.operator            | string  | The resource binding key for the operator label shown for the value.                   | "resource.operator.plus"                                                       |
| resourceBindings.tomtearealSomLeggesTil.unit                | string  | The resource binding key for the unit label shown for the value.                       | "resource.unit.meterSquared"                                                   |

...
export function renderErklaeringTekstElement(component) {
    const htmlAttributes = new CustomElementHtmlAttributes({
        ...
        hideIfEmpty: true,
        resourceBindings: {
            title: component?.resourceBindings?.samsvarErklaeringTekst?.title
        }
    });
...
export function renderPROTekstElement(component) {
    const htmlAttributes = new CustomElementHtmlAttributes({
        ...
        hideIfEmpty: true,
        resourceBindings: {
            title: component?.resourceBindings?.samsvarPROTekst?.title
        }
    });
    return addContainerElement(createCustomElement("custom-paragraph-text", htmlAttributes));
}
...
export function renderUTFTekstElement(component) {
    const htmlAttributes = new CustomElementHtmlAttributes({
        ...
        hideIfEmpty: true,
        resourceBindings: {
            title: component?.resourceBindings?.samsvarUTFTekst?.title
        }
    });
    return addContainerElement(createCustomElement("custom-paragraph-text", htmlAttributes));
}

...
| resourceBindings.title               | string  | The title text resource binding.                                                  | "resource.`partType`.title"         |
| resourceBindings.navn.title          | string  | The resource binding for the name field in the table.                             | "resource.part.navn.title"          |
| resourceBindings.telefonnummer.title | string  | The resource binding for the phone number field in the table.                     | "resource.part.telefonnummer.title" |
| resourceBindings.epost.title         | string  | The resource binding for the email field in the table.                            | "resource.part.epost.title"         |

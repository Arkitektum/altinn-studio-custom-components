 ...
 */
export function renderDispensasjonsvarselHeader(component: InstantiatedComponent | null | undefined, size = "h1") {
 ...
 * @returns {HTMLElement} A custom header text element with the appropriate resource binding for the title.
 */
export function renderBestemmelseHeader(component: InstantiatedComponent | null | undefined, size = "h2") {
    const htmlAttributes = new CustomElementHtmlAttributes({
        isChildComponent: true,
        size: size,
        resourceBindings: {
 ...
 * @returns {HTMLElement} A custom header text element with the appropriate resource binding for the title.
 */
export function renderDispVarselBeskrivelseHeader(component: InstantiatedComponent | null | undefined, size = "h2") {
    const htmlAttributes = new CustomElementHtmlAttributes({
        isChildComponent: true,
        size: size,
        resourceBindings: {
 ...
 */
export function renderSpoersmaalOmDispensasjonssoeknaden(component?: InstantiatedComponent | null) {
    const htmlAttributes = new CustomElementHtmlAttributes({
        isChildComponent: true,
        resourceBindings: {

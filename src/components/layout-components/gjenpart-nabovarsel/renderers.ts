 ...
 */
export function renderGjenpartNabovarselHeader(component: InstantiatedComponent | null | undefined, size = "h1") {
 ...
 */
export function renderGjenpartNabovarselSubHeader(component?: InstantiatedComponent | null) {
    const htmlAttributes = new CustomElementHtmlAttributes({
        isChildComponent: true,
        resourceBindings: {
...
function formatAnsvarligSoekerTiltakshaverData(part?: { navn?: string; organisasjonsnummer?: string | number }) {
    ...
    if ((part?.organisasjonsnummer as string)?.length > 0) {
 ...
 * @returns {HTMLElement} The custom header element.
 */
export function renderDetErVarsletOmHeader(component: InstantiatedComponent | null | undefined, size = "h2") {
    const htmlAttributes = new CustomElementHtmlAttributes({
        isChildComponent: true,
        size: size,
        resourceBindings: {
 ...
 */
export function renderPlanerGjeldendePlanHeaderElement(component?: InstantiatedComponent | null) {
    const htmlAttributes = new CustomElementHtmlAttributes({
        isChildComponent: true,
        size: "h3",
        resourceBindings: {
...
export function renderDispensasjonOversiktElement(component?: InstantiatedComponent | null) {
    ...
    return createCustomElement("custom-group-dispensasjon-oversikt", htmlAttributes);
}

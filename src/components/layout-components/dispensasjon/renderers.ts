 ...
 */
export function renderSoeknadGjelderHeader(component: InstantiatedComponent | null | undefined, size = "h2") {
    const htmlAttributes = new CustomElementHtmlAttributes({
        isChildComponent: true,
        size: size,
        resourceBindings: {
 ...
 */
export function renderDispensasjonFraHeader(component: InstantiatedComponent | null | undefined, size = "h2") {
    const htmlAttributes = new CustomElementHtmlAttributes({
        isChildComponent: true,
        size,
        resourceBindings: {
 ...
 */
export function renderStedfestingHeader(component?: InstantiatedComponent | null) {
    const htmlAttributes = new CustomElementHtmlAttributes({
        isChildComponent: true,
        size: "h2",
        resourceBindings: {
 ...
 */
export function renderVarighetHeader(component: InstantiatedComponent | null | undefined, size = "h2") {
    const htmlAttributes = new CustomElementHtmlAttributes({
        isChildComponent: true,
        size,
        resourceBindings: {
 ...
 * @returns {HTMLElement} The custom header text element.
 */
export function renderBegrunnelseHeader(component: InstantiatedComponent | null | undefined, size = "h2") {
    const htmlAttributes = new CustomElementHtmlAttributes({
        isChildComponent: true,
        size,
        resourceBindings: {

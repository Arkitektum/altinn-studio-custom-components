 ...
 */
export function renderGjennomfoeringsplanHeader(component: InstantiatedComponent | null | undefined, size = "h1") {
 ...
 */
export function renderGjennomfoeringsplanSubHeader(component?: InstantiatedComponent | null) {
    const htmlAttributes = new CustomElementHtmlAttributes({
        isChildComponent: true,
        resourceBindings: {
 ...
 * @returns {HTMLElement} The custom header element.
 */
export function renderPlanenGjelderHeader(component: InstantiatedComponent | null | undefined, size = "h2") {
    const htmlAttributes = new CustomElementHtmlAttributes({
        isChildComponent: true,
        size: size,
        resourceBindings: {

 ...
 */
function renderTableHeaderElement(tableHeader: TableHeader) {
    const th = document.createElement("th");
    th.setAttribute("scope", "col");
    th.textContent = tableHeader.text as string;
 ...
 */
function renderTableRowElement(tableRow: CellComponentProps[]) {
 ...
 */
function renderTableCellElement(tableCell: CellComponentProps) {

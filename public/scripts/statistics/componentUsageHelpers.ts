import type { ApiValue, DisplayLayoutEntry, LayoutComponent } from "../types.ts";
// Dependencies
 ...
 */
function addUsageToGroup(tagName: string, usageInfo: ApiValue, groupedUsage: ApiValue) {
 ...
 */
function handleSubComponentUsages(component: LayoutComponent | undefined, layoutInfo: ApiValue, usageInfo: ApiValue, groupedUsage: ApiValue) {
 ...
 * @returns {void}
 */
function collectComponentUsageTreeGrouped(
    component: LayoutComponent | undefined,
    layoutInfo: ApiValue,
    parentInfo: ApiValue,
    groupedUsage: ApiValue,
    explicitId?: string
) {
...
export function getComponentUsageTreeForAllLayouts(displayLayouts: DisplayLayoutEntry[] | undefined) {
    ...
    customElementTagNames.forEach((tagName: string) => {
        if (!groupedUsage[tagName]) groupedUsage[tagName] = [];
    });

 ...
 */
export function setActiveSidebarElement(itemId: string) {
 ...
 */
export function updateDataInputElement(inputElement: HTMLElement) {
 ...
 */
export function openValidationDialog(contentElement: HTMLElement) {
    ...
    // Set up close button
    (closeDialogButton as HTMLElement).onclick = function () {
